...
def get_content(start_date=now):
    url_index = "https://kjt.yn.gov.cn/html/xinwendongtai/tongzhigonggao/"
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select('.list-text li a')
        time_list = bs.select('.list-text li span')
