...
def get_content(start_date=now):
    ...
    url_index = "https://fgw.jiujiang.gov.cn/zwgk_205/jc/zcwj/index.html"
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select('.info-list a')
        time_list = bs.select('.info-list span')
        ...
        # 进行翻页查找
        if page_num != 10:
            url_index = f"https://fgw.jiujiang.gov.cn/zwgk_205/jc/zcwj/index_{page_num}.html"
            page_num += 1
