...
def get_content(start_date=now):
    url_index = "https://fgw.sc.gov.cn/sfgw/tzgg/list.shtml"
    ...
    while page_turning:
        ...
        for text, tim in zip(text_list, time_list):
            ...
            if re.search(title_pattern, title):  # 匹配标签关键字
                ...
                url_list.append("https://fgw.sc.gov.cn/" + text['href'])
        ...
        if page_num != 20:
            page_num += 1
            url_index = f"https://fgw.sc.gov.cn/sfgw/tzgg/list_{page_num}.shtml"
            # 随机睡眠
