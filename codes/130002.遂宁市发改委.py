...
def get_content(start_date=now):
    ...
    url_base = "https://sfzggw.suining.gov.cn/xinwen/list/57484cce7cdbfb39636d22f1ae231258.html?page={page_num}"
    while page_turning:
        ...
        for text, tim in zip(text_list, time_list):
            ...
            if re.search(title_pattern, title):  # 匹配标签关键字
                ...
                url_list.append("https://sfzggw.suining.gov.cn" + text['href'])
