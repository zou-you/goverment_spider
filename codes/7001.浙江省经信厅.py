...
def get_content(start_date=now):
    url_index = "https://jxt.zj.gov.cn/col/col1582899/index.html"
    ...
    # 定义正则表达式
    record_pattern = r'<p class="lb-list">\s*<a href="(.*?)" target="_blank" title="(.*?)">.*?</a>.*?<span>(.*?)</span>'
    ...
    while page_turning:
        ...
        for record in records:
            ...
            if re.search(title_pattern, title):  # 匹配标签关键字
                ...
                url_list.append("https://jxt.zj.gov.cn/" + href)
