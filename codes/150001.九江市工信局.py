...
def get_content(start_date=now):
    ...
    url_index = "https://gxj.jiujiang.gov.cn/zwgk_248/jc/zcwj/index.html"
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select('.td01 a')
        time_list = bs.select('.td01 span')
        ...
        # 进行翻页查找
        if page_num != 10:
            url_index = f"https://gxj.jiujiang.gov.cn/zwgk_248/jc/zcwj/index_{page_num}.html"
            page_num += 1
