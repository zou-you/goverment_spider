...
def get_content(start_date=now):
    url_index = "https://kjt.henan.gov.cn/tzgg/index.html"
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select(".list_u1 li a")
        time_list = bs.select(".list_u1 li span")
        ...
        # 进行翻页查找
        if page_num != 20:
            url_index = f"https://kjt.henan.gov.cn/tzgg/index_{page_num}.html"
            page_num += 1
            # 随机睡眠
