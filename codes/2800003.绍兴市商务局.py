...
def get_content(start_date=now):
    url_index = "https://swj.sx.gov.cn/col/col1229460800/index.html"
    ...
    # 定义正则表达式
    record_pattern = re.compile(r'#cccccc"><a href="(.*?)"><font color="#333333">(.*?)</font>.*?\[(\d{4}-\d{2}-\d{2})\]')
