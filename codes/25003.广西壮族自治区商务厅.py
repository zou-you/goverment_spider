...
def get_content(start_date=now):
    url_index = "http://swt.gxzf.gov.cn/zfxxgk/fdzdgknr/tzgg/"
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select('.more-list a')
        time_list = bs.select('.more-list span')
