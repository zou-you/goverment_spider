...
def get_content(start_date=now):
    url_index = "https://fzggw.zj.gov.cn/col/col1599544/index.html"
    ...
    # 定义正则表达式
    record_pattern = r'<li class="clearfix">\s*<a class="bt-left" title="(.*?)" href="(.*?)" target="_blank">.*?</a>.*?<span class="bt-right">(.*?)</span>'
