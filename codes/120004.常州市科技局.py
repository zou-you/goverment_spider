...
def get_content(start_date=now):
    url_index = "https://www.changzhou.gov.cn/gova/tzgg.php?catname=kjj_02_04"
    ...
    while page_turning:
        ...
        if page_num != 20:
            page_num += 1
            url_index = f"https://www.changzhou.gov.cn/gova/tzgg.php?catname=kjj_02_04&page={page_num}"
            # 随机睡眠
