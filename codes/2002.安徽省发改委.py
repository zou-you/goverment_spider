...
def get_content(start_date=now):
    url_index = 'https://fzggw.ah.gov.cn/ywdt/tzgg/index.html'
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select(".doc_list.list-49637171 li a")
        time_list = bs.select(".doc_list.list-49637171 li span.right.date")
        ...
        if page_num != 10:
            page_num += 1
            url_index = f"https://fzggw.ah.gov.cn/content/column/49637171?pageIndex={page_num}"
            # 随机睡眠
