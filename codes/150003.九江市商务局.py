...
def get_content(start_date=now):
    ...
    url_index = "https://swj.jiujiang.gov.cn/zwzx_213/gggs/"
    ...
    while page_turning:
        ...
        for text, tim in zip(text_list, time_list):
            ...
            if re.search(title_pattern, title):  # 匹配标签关键字
                ...
                url_list.append("https://swj.jiujiang.gov.cn/zwzx_213/gggs/" + text['href'])
                date_list.append(date)
                title_list.append(title)

        # 进行翻页查找
        if page_num != 10:
            url_index = f"https://swj.jiujiang.gov.cn/zwzx_213/gggs/index_{page_num}.html"
            page_num += 1
