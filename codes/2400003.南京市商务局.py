...
def get_content(start_date=now):
    ...
    while page_turning:
        ...
        # 访问链接
        url_index = "https://swj.nanjing.gov.cn/igs/front/search/publish/data/list.html?&index=wzqsearch-v20190124&type=infomation&siteId=75&pageSize=20&orderProperty=DOCRELTIME&pageIndex=1&orderDirection=desc&filter%5BSITEID%5D=75&filter%5BCHANNELID%5D=35539&filter%5BGROUPCAT%5D=228&pageNumber=1"
