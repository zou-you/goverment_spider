...
def get_content(start_date=now):
    # 深圳市商务局
    url_index = 'https://sti.huizhou.gov.cn/zwgk/bmwj/tzgg/index.html'
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select(".default_pgContainer.araiTheme-shallow a")
        time_list = bs.select(".default_pgContainer.araiTheme-shallow span")
