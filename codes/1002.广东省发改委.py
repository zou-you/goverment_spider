...
def get_content(start_date=now):
    url_index = "http://drc.gd.gov.cn/ywtz/index.html"
    ...
    while page_turning:
        ...
        # 访问链接
        bs = get_bs(url_index)
        text_list = bs.select(".gl-cont2.f-r ul.comlist1.mt10 li a")
        time_list = bs.select(".gl-cont2.f-r ul.comlist1.mt10 li span")
